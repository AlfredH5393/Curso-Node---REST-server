...
const getCategories = async (req = req, res = res) => { 
    ...
    res.status(200).json (GenericFunctions.genericResponse("success",categories,200,[],total))
}
...
const getCategory = async (req = req, res = res) => {   
    ...
    res.status(200).json (GenericFunctions.genericResponse("success",catagory,200,[],1))
}
...
const updateCategory = async (req = req, res = res) => { 
    ...
    res.status(200).json (GenericFunctions.genericResponse("Registro actualizado correctamente", category,200,[],0));
}
